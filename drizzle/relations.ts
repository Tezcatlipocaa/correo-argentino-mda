...
import { agents, cubicAssignments, cubics, offices, officeAssets, contacts, officeContacts, users, sessions, regions, provinces, operators, operatorShifts, operatorSchedules, workLocations, auditParameters, auditScores, qualityAudits, monthlySummaries, terminals, operatorAttendance, weekendOvertimeShifts, agentSaturdayGroups, monthlyGuardiaPasivaOperator, weeklyGuardiaPasivaAssignments, applicationCategories, applications, contactCategories, providerContacts, resourceCategories, resourceLinks, feedback, technologyReferents, officeInvgateLinks, titleCategory, titles } from "./schema";

export const cubicAssignmentsRelations = relations(cubicAssignments, ({one}) => ({
	agent: one(agents, {
...
export const operatorAttendanceRelations = relations(operatorAttendance, ({one}) => ({
	agent: one(agents, {
...
export const monthlyGuardiaPasivaOperatorRelations = relations(monthlyGuardiaPasivaOperator, ({one}) => ({
	agent: one(agents, {
...
export const weeklyGuardiaPasivaAssignmentsRelations = relations(weeklyGuardiaPasivaAssignments, ({one}) => ({
	agent: one(agents, {
...
export const applicationCategoriesRelations = relations(applicationCategories, ({many}) => ({
...
export const officeInvgateLinksRelations = relations(officeInvgateLinks, ({one}) => ({
	office: one(offices, {
